...
// the very shiny visor: glossy physical material — SolarSystem feeds it a
// live CubeCamera envMap so it mirrors the actual scene around it
...
const GLINT = new THREE.MeshBasicMaterial({ color: '#FFFFFF', transparent: true, opacity: 0.7 });
