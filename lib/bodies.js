...
export const BODIES = [
  ...
  },
  {
    ...
    radius: 2.9, orbit: 29, orbitSpeed: 0.44, spinSpeed: 0.9, texture: 'jupiter', gravity: 2.53,
  ...
  },
  {
    ...
    radius: 2.5, orbit: 36, orbitSpeed: 0.33, spinSpeed: 0.85, texture: 'saturn', gravity: 1.07,
    hasRings: true,
  ...
  },
  {
    ...
    radius: 1.7, orbit: 42, orbitSpeed: 0.23, spinSpeed: 0.6, texture: 'ice', gravity: 0.89,
  ...
  },
  {
    ...
    radius: 1.65, orbit: 47.5, orbitSpeed: 0.18, spinSpeed: 0.62, texture: 'ice', gravity: 1.14,
...
export const CANCRI_BODIES = [
  ...
  },
  {
    ...
    radius: 2.5, orbit: 13, orbitSpeed: 1.0, spinSpeed: 0.8, texture: 'jupiter', gravity: 2.0,
  ...
  },
  {
    ...
    base: '#7ED4DC', speckle: '#4FA8B8', gravity: 1.0,
...
export const SYSTEMS = [
  { id: 'sol', name: 'Our Solar System', short: 'Our Sun', emoji: '☀️', center: [0, 0, 0], bodies: BODIES },
  { id: 'proxima', name: 'Proxima Centauri', short: 'Proxima', emoji: '🔴', center: [620, 30, -420], bodies: PROXIMA_BODIES },
  { id: 'trappist', name: 'TRAPPIST-1', short: 'TRAPPIST-1', emoji: '🌟', center: [-680, -40, -520], bodies: TRAPPIST_BODIES },
  { id: 'cancri', name: '55 Cancri', short: '55 Cancri', emoji: '💎', center: [150, 80, 800], bodies: CANCRI_BODIES },
];

/* Everything that can be selected and shown on a card */
export const CARDS = [...BODIES, MOON, ...FEATURES, ...PROXIMA_BODIES, ...TRAPPIST_BODIES, ...CANCRI_BODIES];
