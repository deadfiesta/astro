...
/* Non-planet wonders: shown in the scene and the picker, each with its own card.
   'asteroids', 'kuiper' and 'oort' fly the camera to a viewpoint instead of following a body. */
export const FEATURES = [
  {
    id: 'asteroids', name: 'Asteroid Belt', emoji: '🪨', color: '#D9B98A', glow: '#D9B98A',
    fact: 'Between Mars and Jupiter is the Asteroid Belt — a wide ring of millions of rocky space boulders, some as tiny as pebbles and some as big as small countries.',
    chips: [
      ['🪨 Made of', 'Rocky and metal space boulders'],
      ['📍 Where?', 'Between Mars and Jupiter'],
      ['🥇 Biggest one', 'Ceres — a dwarf planet'],
    ],
    funFacts: [
      'The asteroids are spread so far apart that spaceships fly through without bumping into any!',
      'Ceres is the biggest asteroid — it is round like a tiny planet.',
      'Some asteroids have their own little moons.',
      'If you squished every asteroid together, they would still be smaller than our Moon.',
      'Jupiter\u2019s strong gravity stopped the asteroids from ever forming a planet.',
    ],
  },
  {
...
export const GAIABH1_BODIES = [
  {
    id: 'gaiabh1', name: 'Gaia BH1', short: 'Gaia BH1', emoji: '🕳️', color: '#FF9F5C', glow: '#FF9F5C',
    radius: 2.2, orbit: 0, orbitSpeed: 0, spinSpeed: 0.05, blackHole: true,
    fact: 'Gaia BH1 is the closest black hole to Earth we know! It is invisible — its gravity is SO strong that not even light can escape. We only found it by watching its buddy star wobble.',
    chips: [
      ['🕳️ What is it?', 'A sleeping black hole'],
      ['📍 How far?', '1,560 light-years away'],
      ['⚖️ Weight', 'Almost 10 Suns, squeezed tiny!'],
    ],
    funFacts: [
      'Black holes are invisible — we find them by how they tug on stars.',
      'Whatever falls in can never come back out — not even light!',
      'It was discovered in 2022 with the Gaia space telescope.',
      'Don’t worry — it is far too distant to ever bother Earth!',
    ],
  },
  {
    id: 'gaiabh1-star', name: 'The Buddy Star', short: 'Buddy Star', emoji: '⭐', color: '#FFD54A', glow: '#FF9F1C',
    radius: 1.6, orbit: 9, orbitSpeed: 0.8, spinSpeed: 0.05, gravity: 28, star: true,
    fact: 'This brave little star circles the black hole every 186 days — and it is perfectly safe! It keeps its distance, just like a planet circling a sun.',
    chips: [
      ['🌞 Type', 'A star a lot like our Sun'],
      ['🎂 One lap', '186 days around the black hole'],
      ['😮‍💨 Phew!', 'Far enough away to be safe'],
    ],
    funFacts: [
      'Its tiny wobble is how astronomers found the black hole!',
      'Circling a black hole is safe — as long as you keep your distance.',
      'From this star, the black hole would look like... nothing at all!',
    ],
  },
];
...
export const SYSTEMS = [
  {
    id: 'sol', name: 'Our Solar System', short: 'Our Sun', emoji: '☀️', center: [0, 0, 0], bodies: BODIES, ly: 0, tag: 'Home',
    description: 'Our home! One golden star, eight planets, a lovely Moon, dwarf friends, and belts of icy rubble.',
  },
  {
    id: 'proxima', name: 'Proxima Centauri', short: 'Proxima', emoji: '🔴', center: [620, 30, -420], bodies: PROXIMA_BODIES, ly: 4.2, tag: 'Closest',
  ...
  {
    id: 'trappist', name: 'TRAPPIST-1', short: 'TRAPPIST-1', emoji: '🌟', center: [-680, -40, -520], bodies: TRAPPIST_BODIES, ly: 40, tag: '7 Worlds',
    description: 'A tiny, cool red star hugged by SEVEN Earth-sized planets — the biggest family of little worlds we know.',
  },
  {
    id: 'cancri', name: '55 Cancri', short: '55 Cancri', emoji: '💎', center: [150, 80, 800], bodies: CANCRI_BODIES, ly: 41, tag: 'Super Hot',
    description: 'A sun-like star with five planets — including a lava world that might sparkle with diamonds.',
  },
  {
    id: 'kepler16', name: 'Kepler-16', short: 'Two Suns', emoji: '🌅', center: [-150, -60, -950], bodies: KEPLER16_BODIES, ly: 200, tag: 'Double Glow',
    description: 'The two-sun system! A big orange sun and a little red one dance together, and their planet gets double sunsets.',
  },
  {
    id: 'hd189733', name: 'HD 189733', short: 'Glass Rain', emoji: '🌧️', center: [900, -30, 300], bodies: HD189_BODIES, ly: 64, tag: 'Shiny Drops',
    description: 'Home of a beautiful deep-blue planet with the wildest weather ever found — glass rain blowing sideways!',
  },
  {
    id: 'peg51', name: '51 Pegasi', short: '51 Pegasi', emoji: '🏆', center: [-950, 50, 200], bodies: PEG51_BODIES, ly: 50, tag: 'First Friend',
    description: 'A golden star that made history — the first planet around another sun was discovered right here in 1995.',
  },
  {
    id: 'kepler452', name: 'Kepler-452', short: "Earth's Cousin", emoji: '🌱', center: [450, 100, -900], bodies: KEPLER452_BODIES, ly: 1800, tag: 'Looks Familiar',
    description: 'An older twin of our Sun, home to Earth’s cousin — a bigger Earth with a year almost like ours.',
  },
  {
    id: 'gaiabh1', name: 'Gaia BH1', short: 'Black Hole', emoji: '🕳️', center: [-500, 140, 950], bodies: GAIABH1_BODIES, ly: 1560, tag: 'Super Strong',
    description: 'The nearest black hole to Earth — invisible and super heavy, with one brave star circling it.',
  },
];
